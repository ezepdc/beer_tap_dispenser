...
ActiveRecord::Schema[7.0].define(version: 2023_02_15_162208) do
  ...
  create_table "spendings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dispenser_id"], name: "index_spendings_on_dispenser_id"
  end
  ...
  add_foreign_key "spendings", "dispensers"
end
